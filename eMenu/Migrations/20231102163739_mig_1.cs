        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuPages_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MenuPageId = table.Column<int>(type: "int", nullable: false),
                    MenuCatagoryId = table.Column<int>(type: "int", nullable: true),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuItems_MenuCategories_MenuCatagoryId",
                        column: x => x.MenuCatagoryId,
                        principalTable: "MenuCategories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MenuItems_MenuPages_MenuPageId",
                        column: x => x.MenuPageId,
                        principalTable: "MenuPages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_MenuCatagoryId",
                table: "MenuItems",
                column: "MenuCatagoryId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_MenuPageId",
                table: "MenuItems",
                column: "MenuPageId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuPages_UserId",
                table: "MenuPages",
                column: "UserId");
        }
